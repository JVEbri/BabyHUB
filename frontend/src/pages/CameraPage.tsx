...
export default function CameraPage() {
  ...
  const [sensorReading, setSensorReading] = useState<SensorReading | null>(
    null,
  );
  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4">
        {/* Camera list */}
        <div className="md:col-span-1 bg-white p-3 md:p-2 rounded-lg shadow">
        ...
        {/* Video and controls */}
        <div
          className="md:col-span-3 bg-white p-2 md:p-2 rounded-lg shadow relative"
          ref={containerRef}
        >
          {streamUrl && selectedCamera ? (
            <>
              ...
              <div className="mt-2 md:mt-4 flex justify-center scale-75 md:scale-100 origin-top">
                <PTZPad
                  onDirection={(dir, action) =>
                    moveCamera(selectedCamera.id, dir, action)
                  }
                />
              </div>
            </>
